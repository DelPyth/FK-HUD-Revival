...
Scheme
{
	...
	Colors
	{
		...
		"Red"				"255 85 0 125"
		"Blue"				"33 150 243 2"
		"RedSolid"			"33 150 243 255"
		"Yellow"			"72 76 84 255"
		"TransparentYellow"	"136 14 79 255"
		//"Black"				"0 0 0 255"
		//Changed black to a NTSC safe color
		"GreenSolid"		 "76 107 34 255"

		"Black"				"46 43 42 255"
		"TransparentBlack"	"17 17 17 255"
		"TransparentLightBlack"	"0 0 0 90"
		"FooterBGBlack"		"52 48 55 255"

		"HUDBlueTeam"		"104 124 155 127"
		"HUDRedTeam"		"180 92 77 127"
		"HUDSpectator"		"17 17 17 255"
		"HUDBlueTeamSolid"	"104 124 155 255"
		"HUDRedTeamSolid"	"180 92 77 255"
		"HUDDeathWarning"	"255 0 0 255"
		"HudWhite"			"17 17 17 255"
		...
		"HTMLBackground"						"117 117 117 255"

		"ItemAttribLevel"						"200 200 200 255"
		"ItemAttribNeutral"						"242 242 242 255"
		"ItemAttribPositive"					"33 150 243 255"
		"ItemAttribNegative"					"OrangeTone"
	...
	BaseSettings
	{
		...
		CheckButton.BgColor				"42 160 238 200"
		CheckButton.Border1  			"17 17 17 0" 		// the left checkbutton border
		CheckButton.Border2  			"17 17 17 0"		// the right checkbutton border
		CheckButton.Check				"255 255 255 255"		// color of the check itself
		CheckButton.HighlightFgColor	"77 77 77 255"
		...
		Label.SelectedTextColor			"110 110 110 255"
		Label.BgColor					"Blank"
		Label.DisabledFgColor1			"Blank"
		Label.DisabledFgColor2			"Black"

		ListPanel.TextColor					"Orange"
		ListPanel.BgColor					"33 150 243 255"
		ListPanel.SelectedTextColor			"252 252 252 255"
		ListPanel.SelectedBgColor			"17 17 17 200"
		ListPanel.SelectedOutOfFocusBgColor	"136 14 79 255"
		ListPanel.EmptyListInfoTextColor	"136 14 79 255"
		...
		PropertySheet.TransitionEffectTime	"0.45"	// time to change from one tab to another

		RadioButton.TextColor			"110 110 110 255"
		RadioButton.SelectedTextColor	"110 110 110 255"
		...
		ScrollBarButton.FgColor				"188 188 188 0"
		ScrollBarButton.BgColor				"242 242 242 0"
		ScrollBarButton.ArmedFgColor		"188 188 188 0"
		ScrollBarButton.ArmedBgColor		"242 242 242 0"
		ScrollBarButton.DepressedFgColor	"242 242 242 0"
		ScrollBarButton.DepressedBgColor	"188 188 188 0"

		ScrollBarSlider.FgColor				"255 255 255 255"		// nob color
		ScrollBarSlider.BgColor				"242 242 0 0"		// slider background color
